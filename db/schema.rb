...
ActiveRecord::Schema.define(version: 2019_04_09_082637) do
  ...
  create_table "students", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["classschool_id"], name: "index_students_on_classschool_id"
  end
  ...
  add_foreign_key "students", "classschools"
